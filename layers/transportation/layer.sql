...
RETURNS TABLE(osm_id bigint, geometry geometry, class text, ramp int, oneway int, brunnel TEXT, service TEXT, sac_scale TEXT) AS $$
    SELECT
        osm_id, geometry,
        CASE
    ...
    FROM (
        ...
        SELECT
            ...
            is_bridge, is_tunnel, is_ford, is_ramp, is_oneway, sac_scale, z_order
        ...
        SELECT
            ...
            service_value(service) AS service,
            is_bridge, is_tunnel, is_ford, is_ramp, is_oneway, NULL AS sac_scale, z_order
        ...
        SELECT
            ...
            FALSE AS is_ramp, FALSE AS is_oneway, NULL AS sac_scale, z_order
