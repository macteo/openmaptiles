...
RETURNS TABLE(osm_id bigint, geometry geometry, class text, ramp int, oneway int, brunnel TEXT, service TEXT, sac_scale TEXT, via_ferrata BOOLEAN, via_ferrata_scale TEXT) AS $$
    SELECT
        osm_id, geometry,
        CASE
        ...
        sac_scale, via_ferrata, via_ferrata_scale
    FROM (
        ...
        SELECT
            ...
            service_value(service) AS service,
            is_bridge, is_tunnel, is_ford, is_ramp, is_oneway, NULL AS sac_scale, NULL::boolean AS via_ferrata, NULL AS via_ferrata_scale, z_order
        ...
        -- etldoc: osm_highway_polygon          ->  layer_transportation:z14
        SELECT
            osm_id, geometry,
            highway, NULL AS railway, NULL AS service,
            FALSE AS is_bridge, FALSE AS is_tunnel, FALSE AS is_ford,
            FALSE AS is_ramp, FALSE AS is_oneway, NULL AS sac_scale, NULL::boolean AS via_ferrata, NULL AS via_ferrata_scale, z_order
